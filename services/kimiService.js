...
async function analyzeResume(resumeText) {
  console.log('开始解析简历，长度:', resumeText.length);
  ...
  try {
    ...
    console.error('analyzeResume 错误:', error.message);
    throw error;
  }
}
...
async function analyzeMatch(resumeAnalysis, jobAnalysis) {
  ...
  try {
    ...
    console.error('analyzeMatch 错误:', error.message);
    throw error;
  }
}
